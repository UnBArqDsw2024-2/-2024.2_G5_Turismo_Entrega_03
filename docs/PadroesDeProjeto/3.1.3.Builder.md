...
Para a aplicação desse padrão, primeiro analisamos todas as classes do [Diagrama de Classes do EvenTour](https://unbarqdsw2024-2.github.io/2024.2_G5_Turismo_Entrega_02/#/Modelagem/modelagem%20estatica/2.1.1.DiagramaDeClasses) construindo a interface EventBuilder e as classes EventBuilde e EventDiretor, que irão importar das classes event seus atributos para serem instanciados  por meio da EventBuilder e retornar um objeto do timo event. Após implementamos o modelo criacional que foi elaborado logo abaixo em um código para a representação de como seria a implementação real.
